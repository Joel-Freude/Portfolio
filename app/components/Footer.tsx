        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 md:gap-16 lg:gap-32 mb-8 md:mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <form onSubmit={handleSubscribe} className="flex gap-2">
              ...
              <button
                type="submit"
                className="px-3 md:px-4 py-2 md:py-3 bg-black rounded-lg border border-zinc-500 hover:bg-white transition-colors flex items-center justify-center font-sans"
              >
                <ArrowRight className="w-4 h-4 md:w-5 md:h-5 text-zinc-500 hover:text-black transition-colors" />
              </button>
            </form>
          </div>
